...
import 'package:class_on_cloud/screens/videodemo.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:youtube_player_flutter/youtube_player_flutter.dart';
...
class _VideoDemoState extends State<VideoDemo> {
  List<String> youtubeIdList = ['JBqxVX_LXvk', 'rId62CdFGg4', 'UJATdtg2rZQ'];
  List<String> youtubeURLList = [
    "https://www.youtube.com/watch?v=JBqxVX_LXvk",
    "https://www.youtube.com/watch?v=rId62CdFGg4",
    "https://www.youtube.com/watch?v=UJATdtg2rZQ"
  ];
  ...
  setData() {
    fields = youtubeIdList.length;
    controllers = List.generate(
        fields,
        (i) => YoutubePlayerController(
              initialVideoId: youtubeIdList[i],
              flags: const YoutubePlayerFlags(
                mute: false,
                autoPlay: true,
                disableDragSeek: false,
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: AppBar(
        ...
        title: Text("Home", style: appbarTextStyle(darkmain)),
        actions: const [
          Padding(
            ...
            return SingleChildScrollView(
              child: SizedBox(
                ...
                child: ListView.builder(
                  itemBuilder: (context, i) {
                    return YoutubePlayerBuilder(
                        player: YoutubePlayer(
                          ...
                          onEnded: (data) {
                            controllers[i + 1].load(youtubeIdList[
                                (youtubeIdList.indexOf(data.videoId) + 1) %
                                    youtubeIdList.length]);
                          },
                        ),
                  ...
                  itemCount: youtubeIdList.length,
                ),
              ),
            );
          }
      ...
      //                     )..onInit = () {
      //                         controllers[i]
      //                             .loadVideoById(videoId: youtubeIdList[i]);
      //                       }),
      //               );
      //             },
      //             itemCount: youtubeIdList.length,
